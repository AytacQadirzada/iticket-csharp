...
namespace iticket.Migrations
{
    ...
    [Migration("20251208134512_ChangedVenuesIdToHallIdInProductEvent")]
    partial class ChangedVenuesIdToHallIdInProductEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Iticket.Core.Entities.ProductEvent", b =>
                {
                    ...
                    b.HasOne("Iticket.Core.Entities.Venues", null)
                        .WithMany("ProductEvents")
                        .HasForeignKey("VenuesId");
